...
void phydm_show_trim_debug_info_8822e(void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u8 pg_therm = 0xff;

	odm_efuse_one_byte_read(dm, 0x5c5, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5c5=0x%x\n", __func__, pg_therm);  
	odm_efuse_one_byte_read(dm, 0x5c6, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5c6=0x%x\n", __func__, pg_therm);  
	odm_efuse_one_byte_read(dm, 0x5c7, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5c7=0x%x\n", __func__, pg_therm);

	odm_efuse_one_byte_read(dm, 0x5e4, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5e4=0x%x\n", __func__, pg_therm);  
	odm_efuse_one_byte_read(dm, 0x5e5, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5e5=0x%x\n", __func__, pg_therm);  
	odm_efuse_one_byte_read(dm, 0x5e6, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5e6=0x%x\n", __func__, pg_therm);
	odm_efuse_one_byte_read(dm, 0x5e7, &pg_therm, false);
	RF_DBG(dm, DBG_RF_MP, "======>%s  hide efuse  0x5e7=0x%x\n", __func__, pg_therm);  
}
...
void phydm_get_set_power_trim_offset_8822e(void *dm_void)
{
	...
	odm_efuse_one_byte_read(dm, PPG_2GL_TXAB_22E, &pg_power[0], false);
	odm_efuse_one_byte_read(dm, PPG_2GM_TXAB_22E, &pg_power[1], false);
	odm_efuse_one_byte_read(dm, PPG_2GH_TXAB_22E, &pg_power[2], false);
	odm_efuse_one_byte_read(dm, PPG_5GL1_TXA_22E, &pg_power[3], false);
	odm_efuse_one_byte_read(dm, PPG_5GL1_TXB_22E, &pg_power[4], false);
	odm_efuse_one_byte_read(dm, PPG_5GL2_TXA_22E, &pg_power[5], false);
	odm_efuse_one_byte_read(dm, PPG_5GL2_TXB_22E, &pg_power[6], false);
	odm_efuse_one_byte_read(dm, PPG_5GM1_TXA_22E, &pg_power[7], false);
	odm_efuse_one_byte_read(dm, PPG_5GM1_TXB_22E, &pg_power[8], false);
	odm_efuse_one_byte_read(dm, PPG_5GM2_TXA_22E, &pg_power[9], false);
	odm_efuse_one_byte_read(dm, PPG_5GM2_TXB_22E, &pg_power[10], false);
	odm_efuse_one_byte_read(dm, PPG_5GH1_TXA_22E, &pg_power[11], false);
	odm_efuse_one_byte_read(dm, PPG_5GH1_TXB_22E, &pg_power[12], false);
	...
	for (i = 0; i < pg_num; i++) {
		...
		RF_DBG(dm, DBG_RF_MP, "[kfree] pg_power[%d]=0x%x\n", i, pg_power[i]);	
	}

	RF_DBG(dm, DBG_RF_MP, "[kfree] pg_power_chk=%d\n", pg_power_chk);	

	if (pg_power_chk == pg_num) {
		RF_DBG(dm, DBG_RF_MP, "[kfree] 8822e power trim no PG\n");
	} else {
		//PPG_2GM_TXAB_22E
		power_trim_info->bb_gain[0][0] = pg_power[1] & 0xf;
		power_trim_info->bb_gain[0][1] = (pg_power[1] & 0xf0) >> 4;

		//PPG_2GM_TXAB_22E
		power_trim_info->bb_gain[1][0] = pg_power[1] & 0xf;
		power_trim_info->bb_gain[1][1] = (pg_power[1] & 0xf0) >> 4;

		//PPG_2GM_TXAB_22E
		power_trim_info->bb_gain[2][0] = pg_power[1] & 0xf;
		power_trim_info->bb_gain[2][1] = (pg_power[1] & 0xf0) >> 4;

		//PPG_5GL1_TXA_22E
		power_trim_info->bb_gain[3][0] = pg_power[3] & 0x1f;

		//PPG_5GL1_TXB_22E
		power_trim_info->bb_gain[3][1] = pg_power[4] & 0x1f;

		//PPG_5GL2_TXA_22E
		power_trim_info->bb_gain[4][0] = pg_power[5] & 0x1f;

		//PPG_5GL2_TXB_22E
		power_trim_info->bb_gain[4][1] = pg_power[6] & 0x1f;

		//PPG_5GM1_TXA_22E
		power_trim_info->bb_gain[5][0] = pg_power[7] & 0x1f;
		
		//PPG_5GM1_TXB_22E
		power_trim_info->bb_gain[5][1] = pg_power[8] & 0x1f;

		//PPG_5GM2_TXA_22E
		power_trim_info->bb_gain[6][0] = pg_power[9] & 0x1f;

		//PPG_5GM2_TXB_22E
		power_trim_info->bb_gain[6][1] = pg_power[10] & 0x1f;

		//PPG_5GH1_TXA_22E
		power_trim_info->bb_gain[7][0] = pg_power[11] & 0x1f;

		//PPG_5GH1_TXB_22E
		power_trim_info->bb_gain[7][1] = pg_power[12] & 0x1f;
...
void phydm_get_set_pa_bias_offset_8822e(void *dm_void)
{
	...
	u8 i;
	u8 pg_pa_bias_chk, pg_pa_val;
	u8 pg_num = 4;
	u8 pg_pa_bias[4] = {0};

	RF_DBG(dm, DBG_RF_MP, "======>%s\n", __func__);

	odm_efuse_one_byte_read(dm, PPG_PABIAS_2GA_22E,	&pg_pa_bias[0], false);
	odm_efuse_one_byte_read(dm, PPG_PABIAS_2GB_22E,	&pg_pa_bias[1], false);
	odm_efuse_one_byte_read(dm, PPG_PABIAS_5GA_22E,	&pg_pa_bias[2], false);
	odm_efuse_one_byte_read(dm, PPG_PABIAS_5GB_22E, &pg_pa_bias[3], false);

	pg_pa_bias_chk = 0;
	for (i = 0; i < pg_num; i++) {
		if (pg_pa_bias[i] == 0xff)
			pg_pa_bias_chk++;

		RF_DBG(dm, DBG_RF_MP, "[kfree] pg_pa_bias[%d]=0x%x\n", i, pg_pa_bias[i]);	
	}

	RF_DBG(dm, DBG_RF_MP, "[kfree] pg_pa_bias_chk=%d\n", pg_pa_bias_chk);	

	if (pg_pa_bias_chk == pg_num) {
		RF_DBG(dm, DBG_RF_MP, "[kfree] 8822e pa bias no PG\n");
	} else {
		/*2G s0*/
		pg_pa_val = pg_pa_bias[0] & 0xf;

		RF_DBG(dm, DBG_RF_MP, "[kfree] 2G s0 pa_bias=0x%x\n", pg_pa_val);

		odm_set_rf_reg(dm, RF_PATH_A, 0x60, 0x0000f000, pg_pa_val);

		/*2G s1*/
		pg_pa_val = pg_pa_bias[1] & 0xf;

		RF_DBG(dm, DBG_RF_MP, "[kfree] 2G s1 pa_bias=0x%x\n", pg_pa_val);

		odm_set_rf_reg(dm, RF_PATH_B, 0x60, 0x0000f000, pg_pa_val);

		/*5G s0*/
		pg_pa_val = pg_pa_bias[2] & 0xf;

		RF_DBG(dm, DBG_RF_MP, "[kfree] 5G s0 pa_bias=0x%x\n", pg_pa_val);

		odm_set_rf_reg(dm, RF_PATH_A, 0x60, 0x000f0000, pg_pa_val);

		/*5G s1*/
		pg_pa_val = pg_pa_bias[3] & 0xf;

		RF_DBG(dm, DBG_RF_MP, "[kfree] 5G s1 pa_bias=0x%x\n", pg_pa_val);

		odm_set_rf_reg(dm, RF_PATH_B, 0x60, 0x000f0000, pg_pa_val);
...
void phydm_do_new_kfree(void *dm_void)
{
	...
	if (dm->support_ic_type & ODM_RTL8822E) {
		phydm_show_trim_debug_info_8822e(dm);
