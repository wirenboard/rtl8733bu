...
#define MAX_PATTERN_NAME_LEN	16
/*
...
#define RTL_DEFAULT_PATTERN_PREFIX "rtldflt"
#ifdef CONFIG_GOOGLE_CAST_WAKEUP
#define RTL_GOOGLE_CAST_PATTERN_PREFIX "rtlgcast"
#endif
...
#ifdef CONFIG_GPIO_WAKEUP
void rtw_set_gpio_dft_lvl(_adapter *adapter);
#endif
