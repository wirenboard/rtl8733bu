...
#define _io_records_dump_title(sel, tab) rtw_usb_io_records_dump_title(sel, tab)
#define _io_records_dump_value_by_seq(sel, tab, seq) rtw_usb_io_records_dump_value_by_seq(sel, tab, seq)
#define _io_records_summary_dump(sel) rtw_usb_io_records_summary_dump(sel)
#define _io_records_claim_and_enable(d, enable) rtw_usb_io_records_claim_and_enable(d, enable)
#else
static inline void rtw_usb_io_records_init(void) {}
static inline void rtw_usb_io_records_deinit(void) {}
